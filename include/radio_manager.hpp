...
struct RadioStatus {
    ...
    bool last_tx_timed_out = false;  // Whether the last TX failed by poll timeout rather than IRQ/SPI error.
    ...
    int last_fault = 0;       // Failure point; 10 identifies invalid SPI status during TX.
